...
const Home = () => {
  ...
  useEffect(()=>{
    ...
    return (
      ...
      <h1 className="headerText  font-TulpenOne text-6xl md:text-7xl lg:text-9xl font-extrabold">Developer</h1>
      </div>
      <div className="overflow-clip">
      <h1 className="headerText  font-TulpenOne text-6xl md:text-7xl lg:text-9xl font-extrabold">Designer</h1>
      </div>
        </div>
      
      <div className="overflow-clip">
      <h1 className="headerText  font-TulpenOne text-6xl md:text-7xl lg:text-9xl font-extrabold">Story <br /> Teller</h1>
      </div>
      </div>
      <br /><br />
      <div className="md:flex">
      <div className="w-full lg:max-w-xl paragraphText lg:mx-20 font-AbrilFatface text-xl">
        <p>
      ...
      <div onMouseEnter={()=>{setHovering(true)}} onMouseLeave={()=>{setHovering(false)}} className="hidden md:flex items-end mt-10">
        <div className="flex">
        <img className="h-16" src="https://i.imgur.com/C5rx7Ev.png" alt="" />
        <h1 className="font-AbrilFatface font-bold text-6xl md:text-7xl lg:text-9xl">
